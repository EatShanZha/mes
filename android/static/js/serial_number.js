    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (res.state == "create") {
                ...
                state[0].innerHTML = "扫码人:" + res.userName + "&nbsp&nbsp&nbsp&nbsp" + "工位:" + res.AlreadyCode_station + "<p class='check'>" + "成功" + "</p>"
            } else {
                $(".state").css("border", "5px solid red");
                state[0].innerHTML = "首次扫码时间：" + res.AlreadyCode_time + "&nbsp&nbsp&nbsp&nbsp" + " 扫码人:" + res.userName +"&nbsp&nbsp&nbsp&nbsp" +  "工位:" + res.AlreadyCode_station + "<p class='check'>" + "查看" + "</p>"
            }
            var processGuidance = document.getElementsByClassName("processGuidance");
            var content_main_left = document.getElementsByClassName("content_main_left");
            ...
            if (res.version_commission[0]['大身里布'] !== undefined) {
                $("#lb").text(res.version_commission[0]['大身里布']);
            } else {
                $("#lb").text("");
            }
